...
class NavBar extends Component {
  ...
  render () {
    ...
    let authId
    if (isDefined(this.state.user) && isDefined(this.state.user.sub)) {
      authId = this.state.user.sub
    }
        ...
        <AppBar position='static'>
          <Toolbar>
            ...
            {authId !== undefined && authId !== null ? (
              <LoggedIn authId={authId} auth={auth} styles={styles} />
            ) : (
