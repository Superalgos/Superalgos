function newEdgeEditor() {
    ...
    function onDoubleClick(event) {
        ...
        if (UI.projects.foundations.spaces.chartingSpace.viewport.zoomLevel === UI.projects.foundations.globals.zoom.DOUBLE_CLICK_ZOOM_IN_LEVEL) {
            UI.projects.foundations.spaces.chartingSpace.viewport.zoomAtCenter(UI.projects.foundations.globals.zoom.DOUBLE_CLICK_ZOOM_IN_IN_LEVEL)
            return
        }
    }
    ...
    function getContainer(event, purpose) {
        if (thisObject.container.frame.isThisPointHere(event, undefined, undefined, -EDGE_SIZE) === true && event.buttons !== 2) {
            ...
            point = UI.projects.foundations.utilities.coordinateTransformations.unTransformThisPoint(point, thisObject.container)
    ...
    function draggingPhysics() {
        ...
        let mouseNoZoom = UI.projects.foundations.spaces.chartingSpace.viewport.unTransformThisPoint(mouse.position)
        let mouseWhenDragStartedNoZoom = UI.projects.foundations.spaces.chartingSpace.viewport.unTransformThisPoint(mouseWhenDragStarted.position)
        ...
        switch (whereIsMouseOver) {
            case 'center': {
                switch (whatHappened) {
                    ...
                    case 'left mouse button': {
                        ...
                        let newMinDate = UI.projects.foundations.utilities.dateRateTransformations.getDateFromPointAtContainer(point, thisObject.container.parentContainer, coordinateSystemWhenDragStarted)
                        let newMaxRate = UI.projects.foundations.utilities.dateRateTransformations.getRateFromPointAtContainer(point, thisObject.container.parentContainer, coordinateSystemWhenDragStarted)
                    ...
                    case 'left or right arrow key pressed': {
                        ...
                        let newMinDate = UI.projects.foundations.utilities.dateRateTransformations.getDateFromPointAtContainer(point, thisObject.container.parentContainer, coordinateSystem)
                    ...
                    case 'up or down arrow key pressed': {
                        ...
                        let newMaxRate = UI.projects.foundations.utilities.dateRateTransformations.getRateFromPointAtContainer(point, thisObject.container.parentContainer, coordinateSystem)
            ...
            case 'top': {
                ...
                /* This is equivalent to UI.projects.foundations.utilities.dateRateTransformations.getRateFromPointAtContainer, but as we do not have a container anymore because we already change it, we do it like this. */
            ...
            case 'left': {
                ...
                /* This is equivalent to UI.projects.foundations.utilities.dateRateTransformations.getDateFromPointAtContainer, but as we do not have a container anymore because we already change it, we do it like this. */
    ...
    function drawForeground() {
        ...
        pointA1 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(pointA1, thisObject.container)
        pointA2 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(pointA2, thisObject.container)
        pointA3 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(pointA3, thisObject.container)
        pointA4 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(pointA4, thisObject.container)

        pointB1 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(pointB1, thisObject.container)
        pointB2 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(pointB2, thisObject.container)
        pointB3 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(pointB3, thisObject.container)
        pointB4 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(pointB4, thisObject.container)
        ...
        pointA1 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoViewport(pointA1)
        pointA2 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoViewport(pointA2)
        pointA3 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoViewport(pointA3)
        pointA4 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoViewport(pointA4)

        pointB1 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoViewport(pointB1)
        pointB2 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoViewport(pointB2)
        pointB3 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoViewport(pointB3)
        pointB4 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoViewport(pointB4)
