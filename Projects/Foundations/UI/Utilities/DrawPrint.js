function newFoundationsUtilitiesDrawPrint() {
    ...
    function roundedCornersBackground(params) {
        ...
        if (params.coordinateSystem !== undefined) { // For instance Candles would use this
            ...
            if (params.outsideViewPort === true) { // If the element is not affected by zoom
                borderPoint1 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(borderPoint1, params.container)
                borderPoint2 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(borderPoint2, params.container)
                borderPoint3 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(borderPoint3, params.container)
                borderPoint4 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(borderPoint4, params.container)
    ...
    function drawContainerBackground(container, color, opacity, fitFunction) {
        ...
        fromPoint = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(fromPoint, container)
        toPoint = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(toPoint, container)
...
exports.newFoundationsUtilitiesDrawPrint = newFoundationsUtilitiesDrawPrint