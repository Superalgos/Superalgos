    ...
    menuItemsInitialValues.push(
      {
        ...
        label: undefined,
        visible: true,
        icons: ['menu-tensor-free-angles', 'angle-to-parent-360', 'angle-to-parent-180', 'angle-to-parent-090', 'angle-to-parent-045'],
        rawRadius: 8,
        targetRadius: 0,
        currentRadius: 0,
        ring: 1
    ...
    menuItemsInitialValues.push(
      {
        ...
        label: undefined,
        visible: true,
        icons: ['headphones', 'distance-to-parent-025', 'distance-to-parent-050', 'distance-to-parent-100', 'distance-to-parent-150', 'distance-to-parent-200'],
        rawRadius: 8,
        targetRadius: 0,
        currentRadius: 0,
        ring: 1
