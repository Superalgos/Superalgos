function newFoundationsUtilitiesStrings() {
    ...
    function cleanTextOfCommonWordEndings(text) {
        let result = UI.projects.foundations.utilities.strings.replaceSpecialCharactersForSpaces(text)
        result = result.replaceAll(' ', '')
...
exports.newFoundationsUtilitiesStrings = newFoundationsUtilitiesStrings