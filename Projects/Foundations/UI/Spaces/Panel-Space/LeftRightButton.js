function newLeftRightButton() {
    ...
    function initialize() {
        ...
        rightPosition.y = UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomRight.y
    ...
    function physics() {
        ...
        leftPosition.x = UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft.x
        leftPosition.y = thisObject.parentContainer.frame.position.y

        rightPosition.x = UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomRight.x
