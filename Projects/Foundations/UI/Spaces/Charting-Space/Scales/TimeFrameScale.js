function newTimeFrameScale() {
    ...
    function finalize() {
        ...
        UI.projects.foundations.spaces.chartingSpace.viewport.eventHandler.stopListening(onViewportZoomChangedEventSubscriptionId)
    ...
    function initialize(pLimitingContainer) {
        ...
        onViewportZoomChangedEventSubscriptionId = UI.projects.foundations.spaces.chartingSpace.viewport.eventHandler.listenToEvent('Zoom Changed', onViewportZoomChanged)
    ...
    function adjustTimeFrame(elementsPlotted) {
        ...
        if (
            UI.projects.foundations.spaces.chartingSpace.viewport.zoomTargetLevel >= UI.projects.foundations.globals.zoom.ZOOM_OUT_THRESHOLD_FOR_CHANGING_TIME_FRAME &&
    ...
    function positioningPhysics() {
        ...
        timePoint = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(timePoint, limitingContainer.frame.container)
