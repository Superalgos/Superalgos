...
function newFloatingSpace () {
  ...
  thisObject.container.frame.width = browserCanvas.width * 1
  thisObject.container.frame.height = browserCanvas.height * 1
  thisObject.container.frame.position.x = 0  // browserCanvas.width / 2// - thisObject.container.frame.width / 2
  thisObject.container.frame.position.y = 0 // browserCanvas.height / 2// - thisObject.container.frame.height / 2
