exports.newTestClientsManager = function newTestClientsManager(processIndex, networkCodeName) {
    ...
    */
    ...
    async function initialize() {
        ...
        TS.logger.info('Starting Network "' + networkCodeName + '" with these Test Clients:')
    ...
    async function onMessageReceived(message, userProfile, instance) {
        ...
        switch (message.type) {
            case 'Get Next Test Case': {
                TS.logger.info(currentClientInstance, 'requested a new Test Case')
                ...
                TS.logger.info('Test Case Id ' + nextTestCase.id + ' delivered to', currentClientInstance)
