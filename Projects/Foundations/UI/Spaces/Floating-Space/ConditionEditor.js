...
function newConditionEditor() {
    ...
    function scanDataMines() {
        ...
        for (let i = 0; i < workspace.rootNodes.length; i++) {
            ...
            let dataMineName = UI.projects.foundations.utilities.nodeConfig.loadPropertyFromNodeConfig(dataMine.payload, 'codeName')
            selector[dataMineName] = {}
            let bots = dataMine.sensorBots.concat(dataMine.apiDataFetcherBots).concat(dataMine.indicatorBots)
            for (let j = 0; j < bots.length; j++) {
                let bot = bots[j]
                let botName = UI.projects.foundations.utilities.nodeConfig.loadPropertyFromNodeConfig(bot.payload, 'codeName')
                ...
                for (let k = 0; k < bot.products.length; k++) {
                    ...
                    let productName = UI.projects.foundations.utilities.nodeConfig.loadPropertyFromNodeConfig(product.payload, 'singularVariableName')
                    ...
                    for (let m = 0; m < product.record.properties.length; m++) {
                        ...
                        let propertyName = UI.projects.foundations.utilities.nodeConfig.loadPropertyFromNodeConfig(property.payload, 'codeName')
                        ...
                        let possibleValues = UI.projects.foundations.utilities.nodeConfig.loadPropertyFromNodeConfig(property.payload, 'possibleValues')
                    ...
                    for (let m = 0; m < product.datasets.length; m++) {
                        ...
                        let validTimeFrames = UI.projects.foundations.utilities.nodeConfig.loadPropertyFromNodeConfig(dataset.payload, 'validTimeFrames')
    ...
    function thisObjectDrawForeground() {
        if (thisObject.visible === true) {
            const SIZE = 36
            UI.projects.foundations.utilities.drawPrint.drawIcon(timeFrameIcon, 0, 0, -PICKER_WIDTH * 3.25, -PICKER_HEIGHT * 7, SIZE, thisObject.container)
            UI.projects.foundations.utilities.drawPrint.drawIcon(dataMineIcon, 0, 0, -PICKER_WIDTH * 2.5, -PICKER_HEIGHT * 7, SIZE, thisObject.container)
            UI.projects.foundations.utilities.drawPrint.drawIcon(botIcon, 0, 0, -PICKER_WIDTH * 1.5, -PICKER_HEIGHT * 7, SIZE, thisObject.container)
            UI.projects.foundations.utilities.drawPrint.drawIcon(whenIcon, 0, 0, -PICKER_WIDTH * 0.5, -PICKER_HEIGHT * 7, SIZE, thisObject.container)
            UI.projects.foundations.utilities.drawPrint.drawIcon(productIcon, 0, 0, PICKER_WIDTH * 0.5, -PICKER_HEIGHT * 7, SIZE, thisObject.container)
            UI.projects.foundations.utilities.drawPrint.drawIcon(propertyIcon, 0, 0, PICKER_WIDTH * 1.45, -PICKER_HEIGHT * 7, SIZE, thisObject.container)
            UI.projects.foundations.utilities.drawPrint.drawIcon(operationIcon, 0, 0, PICKER_WIDTH * 2.45, -PICKER_HEIGHT * 7, SIZE, thisObject.container)
            UI.projects.foundations.utilities.drawPrint.drawIcon(valueIcon, 0, 0, PICKER_WIDTH * 3.45, -PICKER_HEIGHT * 7, SIZE, thisObject.container)
        }
    }
}
