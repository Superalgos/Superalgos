if (
  ...
  console.log('');
  console.log(
    'USAGE:                 node runPlatform [help] [noBrowser] [minMemo]'
  );
  console.log('');
  console.log('OPTIONS:');
  console.log('');
  console.log(
    '                       help:        Optional. Use it to see this helping information.'
  );
  console.log(
    '                       noBrowser:   Optional. Use it to launch Superalgos Platform Client only. The Superalgos Platform UI will not be loaded.'
  );
  console.log(
    '                       minMemo:     Optional. Use it when your hardware has less than 8 Gb or memory.'
  );
  console.log('');
  console.log(
    'If you are having an error while trying to run the Superalgos Platform Client, consider this:'
  );
...
let maxOldSpaceSize =
  '--max-old-space-size=' + optimalRAM.toFixed(0).toString();
let options;

console.log('');
console.log(
  'Total RAM istalled in this system is ........................ ' +
    (totalRAM / 1024).toFixed(2) +
    ' GB'
);
if (process.argv.includes('minMemo')) {
  ...
  console.log(
    'Total RAM available for Superalgos is ....................... 512 MB'
  );
} else {
  options = {
  ...
  console.log(
    'Total RAM available for Superalgos is ....................... ' +
      (optimalRAM / 1024).toFixed(2) +
      ' GB'
  );
  console.log('');
  console.log(
...
if (process.argv.includes('minMemo')) {
  optionsAccepted++;
  console.log(
    'minMemo ..................................................... Running with Minimun Required Memory.'
  );
}
...
if (process.argv.includes('noBrowser')) {
  optionsAccepted++;
  console.log(
    'noBrowser ................................................... Running without User Interface.'
  );
}
...
function fatalErrorHelp() {
  console.log('');
  console.log(
    '* If your device does not have MORE than 8GB of RAM then please use the minMemo option.'
  );
  console.log(
    '* If your OS does not have a user interface, please use the noBrowser option.'
  );
  console.log('');
  console.log(
    'If you continue having trouble to start the Superalgos Platform Client try:'
  );
  console.log('');
