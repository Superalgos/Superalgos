    ...
    function render() {
        ...
        function buildHtmlPage() {
            ...
            if (UI.projects.superalgos.spaces.docsSpace.currentDocumentBeingRendered.category === 'Topic') {
                ...
                /* Topic Title */
                titleLabel = thisObject.docsSchemaDocument.topic + ' Topic Content'
                HTML = HTML + '<div id="docs-main-title-div" class="docs-title-table"><div class="docs-table-cell"><h2 class="docs-h2" id="' + UI.projects.superalgos.spaces.docsSpace.currentDocumentBeingRendered.type.toLowerCase().replace(' ', '-') + '" > ' + titleLabel + '</h2></div><div id="projectImageDiv" class="docs-image-container"/></div></div>'
            ...
            */
            ...
            function generateTopicMultiPageIndex() {
                ...
                */
                ...
                for (let i = 0; i < orderedTopicPageIndexArray.length; i++) {
                    ...
                    HTML = HTML + '<p>' + arrayItem.pageNumber + '. ' + '<a class="docs-link" onClick="UI.projects.superalgos.spaces.docsSpace.navigateTo(\'' + UI.projects.superalgos.spaces.docsSpace.currentDocumentBeingRendered.project + '\', \'' + 'Topic' + '\', \'' + arrayItem.type.replace(/'/g, 'AMPERSAND') + '\')">' + paragraph.text + '</a></p>'
                }
            }
            ...
            function addContent() {
                ...
                function addChapterIndex(chapterText) {
                    ...
                    let project = splittedChapterText[0]
                    let chapterNumber = splittedChapterText[1]
                    let chapterName = splittedChapterText[2]
                    let introText = splittedChapterText[3]
                    
                    if (project === undefined || chapterNumber === undefined || chapterName === undefined) {
