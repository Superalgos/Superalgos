...
function newFloatingLayer() {
    ...
    */
    ...
    function checkBoundaries(floatingObject) {
        ...
        if (floatingObject.container.frame.position.x + floatingObject.container.frame.radius > UI.projects.foundations.spaces.floatingSpace.container.frame.width) {
            floatingObject.container.frame.position.x = UI.projects.foundations.spaces.floatingSpace.container.frame.width - floatingObject.container.frame.radius
            floatingObject.currentSpeed.x = -floatingObject.currentSpeed.x
        }
        ...
        if (floatingObject.container.frame.position.y + floatingObject.container.frame.radius > UI.projects.foundations.spaces.floatingSpace.container.frame.height) {
            floatingObject.container.frame.position.y = UI.projects.foundations.spaces.floatingSpace.container.frame.height - floatingObject.container.frame.radius
            floatingObject.currentSpeed.y = -floatingObject.currentSpeed.y
        }
    }
