...
function newSuperalgosTopSpace() {
    ...
    function initialize() {
        ...
        loadImage('sa-beta10-logo-horiz-dark', logoImage)
    ...
    function resize() {
        ...
        try {
            thisObject.container.frame.position.y = UI.projects.superalgos.spaces.chartingSpace.viewport.visibleArea.bottomLeft.y
        } catch (e) { }
    }
