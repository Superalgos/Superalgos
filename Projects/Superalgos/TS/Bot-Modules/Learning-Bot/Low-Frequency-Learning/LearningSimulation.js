            ...
            if (TS.projects.superalgos.globals.processVariables.VARIABLES_BY_PROCESS_INDEX_MAP.get(processIndex).TRADING_PROCESSING_DAILY_FILES) {
                ...
                */
                ...
                for (let i = 0; i < candles.length; i++) {
                    ...
                    if (candle.begin >= TS.projects.superalgos.globals.processVariables.VARIABLES_BY_PROCESS_INDEX_MAP.get(processIndex).SIMULATION_STATE.learningEngine.learningCurrent.learningEpisode.processDate.value) {
            ...
            function heartBeat() {
                ...
                if (sessionParameters.heartbeats !== undefined) {
                    if (sessionParameters.heartbeats.config.date === true || sessionParameters.heartbeats.config.candleIndex === true) {
                        ...
                        heartBeatDate = new Date(Math.trunc(learningEngine.learningCurrent.learningEpisode.candle.begin.value / TS.projects.superalgos.globals.timeConstants.ONE_DAY_IN_MILISECONDS) * TS.projects.superalgos.globals.timeConstants.ONE_DAY_IN_MILISECONDS)
                        ...
                        */
                        if (heartBeatDate.valueOf() !== previousHeartBeatDate) {
                            ...
                            TS.projects.superalgos.globals.loggerVariables.VARIABLES_BY_PROCESS_INDEX_MAP.get(processIndex).BOT_MAIN_LOOP_LOGGER_MODULE_OBJECT.write(MODULE_NAME,
                                '[INFO] runSimulation -> loop -> Simulation ' + TS.projects.superalgos.globals.processVariables.VARIABLES_BY_PROCESS_INDEX_MAP.get(processIndex).SESSION_KEY + ' Loop # ' + learningEngine.learningCurrent.learningEpisode.candle.index.value + ' @ ' + processingDate)
                    ...
                    if (
                        ...
                        */
                        ...
                        learningEngine.learningCurrent.learningEpisode.processDate.value =
                            learningEngine.learningCurrent.learningEpisode.processDate.value + TS.projects.superalgos.globals.timeConstants.ONE_DAY_IN_MILISECONDS
                        return false
                    }
            ...
            function checkMinimunAndMaximunBalance() {
                ...
                if (
                    ...
                    */
                    ...
                    let stopRunningDate = (new Date(learningEngine.learningCurrent.learningEpisode.candle.begin.value)).toUTCString()

                    if (sessionParameters.sessionBaseAsset.config.minimumBalance !== undefined) {
                        if (learningEngine.learningCurrent.learningEpisode.episodeBaseAsset.balance.value <= sessionParameters.sessionBaseAsset.config.minimumBalance) {
                            ...
                            let contextInfo = {
                                ...
                                episodeBaseAssetBalance: learningEngine.learningCurrent.learningEpisode.episodeBaseAsset.balance.value,
                    ...
                    if (sessionParameters.sessionBaseAsset.config.maximumBalance !== undefined) {
                        if (learningEngine.learningCurrent.learningEpisode.episodeBaseAsset.balance.value >= sessionParameters.sessionBaseAsset.config.maximumBalance) {
                    ...
                    if (sessionParameters.sessionQuotedAsset.config.minimumBalance !== undefined) {
                        if (learningEngine.learningCurrent.learningEpisode.episodeQuotedAsset.balance.value <= sessionParameters.sessionQuotedAsset.config.minimumBalance) {
                            const errorMessage = 'Min Balance reached @ ' + stopRunningDate
                            ...
                            let contextInfo = {
                                timestamp: stopRunningDate,
                                episodeQuotedAssetBalance: learningEngine.learningCurrent.learningEpisode.episodeQuotedAsset.balance.value,
                    ...
                    if (sessionParameters.sessionQuotedAsset.config.maximumBalance !== undefined) {
                        if (learningEngine.learningCurrent.learningEpisode.episodeQuotedAsset.balance.value >= sessionParameters.sessionQuotedAsset.config.maximumBalance) {
                            const errorMessage = 'Max Balance reached @ ' + stopRunningDate
