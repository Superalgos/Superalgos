        ...
        function buildHtmlPage() {
            ...
            if (UI.projects.superalgos.spaces.docsSpace.currentDocumentBeingRendered.category === 'Review') {
                ...
                */
                ...
                HTML = HTML = HTML + '<div class="docs-topic-index">' // Container for Review Navigation including buttons, title and index
                ...
                HTML = HTML = HTML + '</div>'  // END Container for Review Navigation
            }
