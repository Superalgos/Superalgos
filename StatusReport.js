    ...
    */
    ...
    function initialize(pStatusDependencyNode, callBackFunction) {
        try {
            ...
            if (bot.AI_SESSION !== undefined && statusDependencyNode.bottype === "AI Bot") {
                sessionPath = bot.AI_SESSION.folderName + "/"
            }
    ...
    function load(callBackFunction) {
        ...
        try {
            ...
            */
            if (bot.TRADING_SESSION !== undefined || bot.AI_SESSION !== undefined) {
