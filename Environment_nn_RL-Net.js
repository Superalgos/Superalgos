...
exports.newEnvironment = function () {
    ...
    let thisObject = {
        ...
        PLATFORM_WEB_SOCKETS_INTERFACE_PORT: 18040,
        PLATFORM_HTTP_INTERFACE_PORT: 34247,
        DESKTOP_WEB_SOCKETS_INTERFACE_PORT: 16040,
        DESKTOP_WEB_SOCKETS_INTERFACE_HOST: 'localhost',
        NETWORK_WEB_SOCKETS_INTERFACE_HOST: 'miner2.fritz.box',
        NETWORK_WEB_SOCKETS_INTERFACE_PORT: 18039,
        NETWORK_HTTP_INTERFACE_PORT: 31246,
        DESKTOP_HTTP_INTERFACE_PORT: 33247,
