...
function newUsersModule() {

    const MODULE_NAME = "Users Module Button";
    ...
    function initialize(callBackFunction) {
        ...
        try {
            ...
            icon.src = window.canvasApp.urlPrefix + "Images/Icons/users-module.png";
    ...
    function onClick() {
        ...
        try {
            ...
            window.open('https://users.advancedalgos.net', '_blank');
