function newCandlesPlottersCandlesVolumesVolumes() {
                ...
                if (volumes.length > 0) {
                    ...
                    for (let i = 0; i < volumes.length; i++) {
                        ...
                        function calculateBuys(plot, height) {
                            ...
                            volumePointA1 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(volumePointA1, thisObject.container);
                            volumePointA2 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(volumePointA2, thisObject.container);
                            volumePointA3 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(volumePointA3, thisObject.container);
                            volumePointA4 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(volumePointA4, thisObject.container);
                            ...
                            if (volumePointA4.x < UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomLeft.x || volumePointA1.x > UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomRight.x) {
                                return false;
                            }
                        ...
                        let diffA = volumePointA1.y - UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomLeft.y
                        if (diffA > 0) {
                        ...
                        function calculateSells(plot, height) {
                            ...
                            volumePointB1 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(volumePointB1, thisObject.container);
                            volumePointB2 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(volumePointB2, thisObject.container);
                            volumePointB3 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(volumePointB3, thisObject.container);
                            volumePointB4 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(volumePointB4, thisObject.container);
                        }

                        calculateSells(coordinateSystem, thisObject.container.frame.height); // We try to see if it fits in the visible area.

                        let diffB = volumePointB1.y - UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft.y
                        if (diffB < 0) {
                        ...
                        volumePointA1 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(volumePointA1);
                        volumePointA2 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(volumePointA2);
                        volumePointA3 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(volumePointA3);
                        volumePointA4 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(volumePointA4);

                        volumePointB1 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(volumePointB1);
                        volumePointB2 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(volumePointB2);
                        volumePointB3 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(volumePointB3);
                        volumePointB4 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(volumePointB4);
