    ...
    async function createOrder(tradingSystemOrder, tradingEngineOrder) {
        ...
        try {
            ...
            function errorFooter() {
                ...
                logError('Double check that you copied the key at the codeName property and the secret at secret property without bringing any invisible character from the exchange web site, or leaving any character from the sample text. Also check that the keys are not disabled at the exchange ot that they are not restricted by IP.')
