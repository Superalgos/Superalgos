    ...
    function drawForeground() {
        ...
        for (let i = 0; i < VISIBLE_LABELS; i++) {
            ...
            if (i === 2 || isMouseOver === true) {
                UI.projects.foundations.utilities.drawPrint.drawLabel(label, 1 / 2, i / VISIBLE_LABELS, 0, 0, fontSize, thisObject.container, fontColor, undefined, undefined, opacity)
            }
        }
    }
}
