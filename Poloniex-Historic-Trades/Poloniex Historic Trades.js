exports.newPloniexHistoricTrades = function newPloniexHistoricTrades(BOT) {
    ...
    const MODULE_NAME = "Poloniex Exchange Historic Trades";
    const LOG_INFO = true;
