                  ...
                  <DialogContent>
                    <Mutation mutation={GET_AZURE_SAS} >
                      {(getAzureSAS, { loading, error, data }) => {
                        ...
                        if (this.state.avatar === null && team.profile !== null && team.profile.avatar === undefined) avatar = 'https://aadevelop.blob.core.windows.net/module-teams/module-default/aa-avatar-default.png'
                        let banner = null
                        ...
                        if (this.state.banner === null && team.profile !== null && team.profile.banner === undefined) banner = 'https://aadevelop.blob.core.windows.net/module-teams/module-default/aa-banner-default.png'
