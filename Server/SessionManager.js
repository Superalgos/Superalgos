exports.newSessionManager = function newSessionManager() {
    ...
    function initialize(ecosystem, storage, callBackFunction) {

        try {
            // TODO Sessions need to be handled by the master app

            const sessions = require('./config/sessions.json');
            ...
            // storage.initialize(undefined, ecosystem);
