      ...
      case 'Strategy Entry Event': {
        menuItemsInitialValues = [
          ...
          },
          {
            ...
            label: 'Add Situation',
            visible: false,
            imagePathOn: 'attractive',
            imagePathOff: 'attractive',
            rawRadius: 8,
            targetRadius: 0,
            currentRadius: 0,
            angle: 0
      ...
      case 'Stop': {
        menuItemsInitialValues = [
          ...
          },
          {
            ...
            label: 'Add Phase',
            visible: false,
            imagePathOn: 'placeholder',
            imagePathOff: 'placeholder',
            rawRadius: 8,
            targetRadius: 0,
            currentRadius: 0,
            angle: 0
