function newLayersPanel() {
    ...
    function initialize() {
        ...
        let position = { // Default position
            x: UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft.x,
            y: UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft.y
        }
    ...
    function panelSizePhysics() {
        ...
        let viewPortHeight = UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomLeft.y - UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft.y
