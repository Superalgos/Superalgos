exports.newNetworkApp = function newNetworkApp() {
    ...
    async function run() {
        ...
        SA.logger.info('Minimum Token Power Required to Connect to this Network Node (inactive)....... ' + SA.projects.governance.utilities.balances.toSABalanceString(thisObject.p2pNetworkNode.node.config.clientMinTokenAllocation))
