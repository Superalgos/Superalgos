            ...
            */
            switch (true) {
                case tradingSystemOrder.type === 'Market Buy Order' || tradingSystemOrder.type === 'Limit Buy Order': {
                    if (tradingEngineOrder.orderStatistics.actualRate.value > tradingEngine.tradingCurrent.episode.candle.max.value) {
                        ...
                        contextInfo = {
                            previousActualRate: tradingEngineOrder.orderStatistics.actualRate.value,
                            recalculatedActualRate: tradingEngine.tradingCurrent.episode.candle.max.value
                        }
                        TS.projects.superalgos.utilities.docsFunctions.buildPlaceholder(docs, undefined, undefined, undefined, undefined, undefined, contextInfo)

                        tradingSystem.addWarning(
                            [
                                [tradingEngineOrder.orderStatistics.actualRate.id, tradingEngine.tradingCurrent.episode.candle.max.id],
                                message,
                                docs
                            ]
                        )
                        tradingEngineOrder.orderStatistics.actualRate.value = tradingEngine.tradingCurrent.episode.candle.max.value
                    }
                    break
                }
                case tradingSystemOrder.type === 'Market Sell Order' || tradingSystemOrder.type === 'Limit Sell Order': {
                    if (tradingEngineOrder.orderStatistics.actualRate.value < tradingEngine.tradingCurrent.episode.candle.min.value) {
                        ...
                        tradingSystem.addWarning(
                            [
                                [tradingEngineOrder.orderStatistics.actualRate.id, tradingEngine.tradingCurrent.episode.candle.min.id],
                                message,
                                docs
                            ]
                        )
                        tradingEngineOrder.orderStatistics.actualRate.value = tradingEngine.tradingCurrent.episode.candle.min.value
                    }
                    break
                }
            }
        ...
        */
        ...
        switch (tradingSystemOrder.type) {
            case 'Limit Buy Order': {
                if (tradingEngine.tradingCurrent.episode.candle.min.value <= tradingEngineOrder.orderStatistics.actualRate.value) {
                    orderWasHit = true
                }
                break
            }
            case 'Limit Sell Order': {
                if (tradingEngine.tradingCurrent.episode.candle.max.value >= tradingEngineOrder.orderStatistics.actualRate.value) {
                    orderWasHit = true
                }
                break
            }
