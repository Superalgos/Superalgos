            ...
            */
            ...
            function saveApiAppFile() {
              ...
              try {
                ...
                secretsFile = secretsFile || { secrets: [] }; // Initialize secretsFile if null or undefined
              } catch (err) {
                const response = {
                  result: 'Error',
              ...
              if (!secretsFile || !Array.isArray(secretsFile) || secretsFile.some(item => typeof item !== 'object' || !item.nodeCodeName || !item.apiToken)) {
