    ...
    function calculate(
        ...
        */
        ...
        function reserMentorshipProgram(node) {
            ...
            */
            if (
                ...
                reserMentorshipProgram(node.tokenSwitch.mentorshipProgram)
                return
            }
            /*
            ...
            */
            if (
                ...
                reserMentorshipProgram(node.userReferrer)
                return
            }
            /*
        ...
        function distributeMentorshipProgram(mentorshipProgram) {
            ...
            */
            mentorshipProgram.payload.mentorshipProgram.ownPower = referringPower
        ...
        function distributeMentorshipPower(
            ...
            switch (node.type) {
                case 'Mentorship Program': {
                    ...
                    */
                    node.payload.mentorshipProgram.outgoingPower = node.payload.mentorshipProgram.outgoingPower + referringPower
                    /*
        ...
        function calculateMentorshipProgram(mentorshipProgram) {
            ...
            */
            if (
                ...
                mentorshipProgram.payload.uiObject.setErrorMessage("In order to be awarded " + mentorshipProgram.payload.mentorshipProgram.awarded.tokens + " SA Tokens from your mentorships, you need first to define yourself who your referrer is.")
        ...
        function drawUserReferrer(node) {
            if (node.payload !== undefined) {
                const ownPowerText = new Intl.NumberFormat().format(node.payload.parentNode.payload.mentorshipProgram.ownPower)
                const incomingPowerText = new Intl.NumberFormat().format(node.payload.parentNode.payload.mentorshipProgram.incomingPower)
                const outgoingPowerText = new Intl.NumberFormat().format(node.payload.parentNode.payload.mentorshipProgram.outgoingPower)
        ...
        function drawMentorshipProgram(node) {
            ...
            if (node.tokensAwarded !== undefined && node.tokensAwarded.payload !== undefined) {
                ...
                node.tokensAwarded.payload.uiObject.setStatus('From '+  node.payload.referralProgram.count + ' Mentorships.')
            }
        }
    }
}