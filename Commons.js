        ...
        try {
            ...
            function getHistoricTrades() {
                ...
                try {
                    ...
                    */
                    ...
                    logger.write("[ERROR] getContextVariables -> getHistoricTrades -> err = " + err.message);
                    callBackFunction(global.DEFAULT_FAIL_RESPONSE);
                }
            }
            ...
            function getOneMinDailyCandlesVolumes() {
                ...
                try {
                    ...
                    logger.write("[ERROR] getContextVariables -> getOneMinDailyCandlesVolumes -> err = " + err.message);
                    callBackFunction(global.DEFAULT_FAIL_RESPONSE);
                }
            }
