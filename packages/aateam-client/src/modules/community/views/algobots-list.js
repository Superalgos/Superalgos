...
export const AlgobotsList = props => (state, actions) => {
  ...
  if (
    ...
    return (
      <div class='section' key='algobotsList2'>
        <p class='is-size-4'>You don't have an algobot yet!</p>
  ...
  if (
    ...
    return (
      <div class='section' key='algobotsList3'>
        <p
  ...
  return (
    <div class='section' key='algobotsList4'>
