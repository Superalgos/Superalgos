...
function newFoundationsChartingSpace() {
    ...
    function oneScreenLeft() {
        ...
        UI.projects.foundations.spaces.chartingSpace.viewport.displace(displaceVector, true)
    }
        ...
        function initializeTimeMachine(node, syncWithDesignerLoop) {
            ...
            function onTimeMachineInitialized() {
                ...
                if (UI.projects.foundations.spaces.chartingSpace.viewport !== undefined) {
                    UI.projects.foundations.spaces.chartingSpace.viewport.raiseEvents() // These events will impacts on objects just initialized.
                }
            }
        }
    }
