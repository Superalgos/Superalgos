...
exports.newOrderMessage = function newOrderMessage() {
  ...
  function createMessage(messageId, from, to, messageType, messageDateTime, orderId, creator, orderDateTime,
    owner, exchange, market, marginEnabled, type, rate, stop, takeProfit, direction, size, status, sizeFilled, exitOutcome, statusDetails) {
  ...
  function createMessageFromObject(object) {
    ...
    return createMessage(object.id, object.from, object.to, object.messageType, object.dateTime, object.order.id,
      ...
      object.order.direction, object.order.size, object.order.status, object.order.sizeFilled, object.order.exitOutcome, object.order.statusDetails)
  }

  function getMessage(fileContent) {
    let parsedFileContent = JSON.parse(JSON.stringify(fileContent))
    ...
    return {
      ...
      order: {
        ...
        statusDetails: parsedFileContent[5][16],
      }
    }
  }
