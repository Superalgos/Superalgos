...
This module gets the requested file from the appropiate cloud storage account. 
...
function newFileServer() {
    ...
    function getMarketIndexCandles(exchangeId, marketId, callBackFunction) {
        ...
        let filePath = EXCHANGE_NAME + "/Output/" + CANDLES_FOLDER_NAME + "/24-hs-Market";
    ...
    function getMarketIndexVolumes(exchangeId, marketId, callBackFunction) {
        ...
        let fileName = '' + 'USDT' + '_' + 'BTC' + '.json';
        let filePath = EXCHANGE_NAME + "/Output/" + VOLUMES_FOLDER_NAME + "/24-hs-Market";
