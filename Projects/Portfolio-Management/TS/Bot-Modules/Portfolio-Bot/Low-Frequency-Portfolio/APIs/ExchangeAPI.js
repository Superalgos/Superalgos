exports.newPortfolioManagementBotModulesExchangeAPI = function (processIndex) {
    ...
    async function getOrder(portfolioSystemOrder, portfolioEngineOrder) {
  
        let orderId = portfolioEngineOrder.exchangeId.value
        ...
        try {
            ...
            TS.projects.education.utilities.docsFunctions.buildPlaceholder(docs, err, portfolioSystemOrder.name, undefined, undefined, undefined, contextInfo)
  
            portfolioSystem.addError([portfolioSystemOrder.id, message, docs])
    ...
    async function createOrder(portfolioSystemOrder, portfolioEngineOrder) {
  
        let price = portfolioEngineOrder.rate.value                           // CCXT: how much quote currency you are willing to pay for a trade lot of base currency (for limit orders only)
        ...
        let amount = portfolioEngineOrder.orderBaseAsset.size.value           // CCXT: how much of currency you want to trade, in Base Asset.
        ...
        try {
            ...
            portfolioSystem.addError([exchangeApiKey.id, message, docs])
    ...
    async function cancelOrder(portfolioSystemOrder, portfolioEngineOrder) {
