exports.newTradingExecution = function (processIndex, bot, logger, tradingEngineModule) {
    /*
    ...
    */
    ...
    let tradingOrdersModule = TRADING_ORDERS_MODULE.newTradingOrders(processIndex, bot, logger, tradingEngineModule)
