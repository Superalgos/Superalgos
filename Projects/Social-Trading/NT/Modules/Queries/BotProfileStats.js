    ...
    function initialize(queryReceived) {
        ...
        */
        ...
        if (queryReceived.targetUserProfileId !== undefined) {
            userProfile = SA.projects.socialTrading.globals.memory.maps.SOCIAL_PERSONAS_BY_ID.get(queryReceived.targetUserProfileId)
        } else {
            userProfile = SA.projects.socialTrading.globals.memory.maps.SOCIAL_PERSONAS_BY_HANDLE.get(queryReceived.targetUserProfileHandle)
        }
