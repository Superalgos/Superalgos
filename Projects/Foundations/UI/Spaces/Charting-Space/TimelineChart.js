function newTimelineChart() {
    ...
    function finalizeLayerManager() {
        ...
        UI.projects.foundations.spaces.panelSpace.destroyPanel(layersPanelHandle)
    }
    ...
    function initializeLayerManager() {
        ...
        layersPanelHandle = UI.projects.foundations.spaces.panelSpace.createNewPanel('Layers Panel', undefined, owner)
        thisObject.layerManager = UI.projects.foundations.spaces.panelSpace.getPanel(layersPanelHandle)
