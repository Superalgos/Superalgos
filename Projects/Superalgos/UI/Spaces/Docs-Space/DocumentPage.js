    ...
    function render() {
        ...
        function buildHtmlPage() {
            ...
            if (UI.projects.superalgos.spaces.docsSpace.objectBeingRendered.category === 'Topic') {
                /* Topic Title */
                titleLabel = docsSchemaDocument.topic + ' - Page ' + docsSchemaDocument.pageNumber
                HTML = HTML + '<div id="docs-main-title-div" class="docs-title-table"><div class="docs-table-cell"><h2 class="docs-h2" id="' + UI.projects.superalgos.spaces.docsSpace.objectBeingRendered.type.toLowerCase().replace(' ', '-') + '" > ' + titleLabel + '</h2></div><div id="projectImageDiv" class="docs-image-container"/></div></div>'
            ...
            */
            ...
            function generateMultiPageIndex() {
                ...
                */
                ...
                let paragraph = {
                    style: "Title",
                    text: "<h3>" + docsSchemaDocument.topic + " TOC</H3>"
                }

                HTML = HTML = HTML + '<div class="docs-topic-index">' // Container for title and index
                ...
                for (let i = 0; i < orderedIndexArray.length; i++) {
                    ...
                    autoGeneratedParagraphIndex++
                    HTML = HTML + '<p><a onClick="UI.projects.superalgos.spaces.docsSpace.navigateTo(\'' + UI.projects.superalgos.spaces.docsSpace.objectBeingRendered.project + '\', \'' + 'Topic' + '\', \'' + arrayItem.type.replace(/'/g, 'AMPERSAND') + '\')">' + paragraph.text + '</a></p>'
                }
