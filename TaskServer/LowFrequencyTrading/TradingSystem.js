exports.newTradingSystem = function (processIndex, bot, logger, tradingEngineModule) {
    /*
    ...
    */
    ...
    let tradingStagesModule = TRADING_STAGES_MODULE.newTradingStages(processIndex, bot, logger, tradingEngineModule)
