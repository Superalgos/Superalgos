        ...
        function createNodesFromPath(node, pathArray) {
            ...
            */
            ...
            if (pathArray.length === 0) {
                ...
                */
                let childNode = UI.projects.visualScripting.nodeActionFunctions.uiObjectsFromNodes.addUIObject(node, 'Asset')
                ...
                */
                let childNode = UI.projects.visualScripting.nodeActionFunctions.uiObjectsFromNodes.addUIObject(node, 'Asset Class')
                childNode.config = JSON.stringify({ codeName: nextItem })
                childNode.name = nextItem
                createNodesFromPath(childNode, pathArray)
            }
