function newSuperalgosDocSpace() {
    ...
    function renderSearchResultsPage() {
        ...
        HTML = HTML + '<input id="docs-search-result-tab-all" type="radio" name="docs-results-tabs" checked=""><label for="docs-search-results-header-tab-all">All</label>'
        HTML = HTML + '<input id="docs-search-result-tab-nodes" type="radio" name="docs-results-tabs"><label for="docs-search-results-header-tab-nodes">Nodes</label>'
        HTML = HTML + '<input id="docs-search-result-tab-concepts" type="radio" name="docs-results-tabs"><label for="docs-search-results-header-tab-concepts">Concepts</label>'
        HTML = HTML + '<input id="docs-search-result-tab-topics" type="radio" name="docs-results-tabs"><label for="docs-search-results-header-tab-topics">Topics</label>'
        HTML = HTML + '<input id="docs-search-result-tab-projects" type="radio" name="docs-results-tabs"><label for="docs-search-results-header-tab-projects">Projects</label>'
        HTML = HTML + '<input id="docs-search-result-tab-code" type="radio" name="docs-results-tabs"><label for="docs-search-results-header-tab-code">Code</label>'
        HTML = HTML + '<input id="docs-search-result-tab-configs" type="radio" name="docs-results-tabs"><label for="docs-search-results-header-tab-configs">Configs</label>'
        HTML = HTML + '</div>'
        ...
        HTML = HTML + '<div id="docs-search-result-content-all">'
        ...
        HTML = HTML + '<div class="docs-search-result-content">'
        HTML = HTML + '<div id="docs-search-result-content-nodes">'
        HTML = HTML + '<div class="docs-search-result-content-record-container">'
        HTML = HTML + '<p class="docs-search-result-content-record-project-category">Superalgos > Node</p>'
        HTML = HTML + '<p><a class="docs-search-result-content-record-title" href="data-storage.html">Data Storage</a></p>'
        HTML = HTML + '<p class="docs-search-result-content-record-extract">The data storage node holds the definitions as to what data is stored in the corresponding network node.</p>'
