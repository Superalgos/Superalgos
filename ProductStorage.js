...
function newProductStorage (name) {
  ...
  function initialize (dataMine, bot, session, product, exchange, market, pDatetime, pTimeFrame, host, port, callBackFunction) {
    try {
      datetime = pDatetime
      ...
      for (let i = 0; i < product.datasets.length; i++) {
        ...
        switch (dataset.code.type) {
          case 'Market Files': {
            ...
            marketFiles.initialize(dataMine, bot, session, product, dataset, exchange, market, host, port, onMarketFileReady)
          ...
          case 'Daily Files': {
            ...
            dailyFiles.initialize(dataMine, bot, session, product, dataset, exchange, market, pDatetime, pTimeFrame, host, port, onDailyFileReady)
          ...
          case 'Single File': {
            ...
            singleFile.initialize(dataMine, bot, session, product, dataset, exchange, market, host, port, onSingleFileReady)
          ...
          case 'File Sequence': {
            ...
            fileSequences.initialize(dataMine, bot, session, product, dataset, exchange, market, host, port, onFileSequenceReady)
