        ...
        try {
            ...
            if (bands.length > 0) {
                ...
                for (let i = 1; i < bands.length; i++) {
                    ...
                    bandPoint1 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(bandPoint1, thisObject.container);
                    bandPoint2 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(bandPoint2, thisObject.container);
                    bandPoint3 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(bandPoint3, thisObject.container);
                    bandPoint4 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(bandPoint4, thisObject.container);
                    bandPoint5 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(bandPoint5, thisObject.container);
                    bandPoint6 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(bandPoint6, thisObject.container);

                    if (bandPoint2.x < UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomLeft.x || bandPoint1.x > UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomRight.x) {
                        continue;
                    }
                    ...
                    if (UI.projects.foundations.spaces.chartingSpace.viewport.zoomTargetLevel < UI.projects.foundations.globals.zoom.ZOOM_OUT_THRESHOLD_FOR_PACKING_OBJECTS_AT_THE_BOTTOM_OR_TOP_OF_VIEWPORT) {
                        let diffA = bandPoint1.y - UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomLeft.y
                        if (diffA > 0) {
                        ...
                        let diffB = bandPoint2.y - UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft.y
                        if (diffB < 0) {
                    ...
                    bandPoint1 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(bandPoint1);
                    bandPoint2 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(bandPoint2);
                    bandPoint3 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(bandPoint3);
                    bandPoint4 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(bandPoint4);
                    bandPoint5 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(bandPoint5);
                    bandPoint6 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(bandPoint6);
                    ...
                    if (
                        bandPoint1.x < UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft.x + 150
                        ||
                        bandPoint1.x > UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomRight.x - 150
                    ) {
