function newSuperalgosFunctionLibrarySocialBotsFunctions() {
    ...
    function sendTelegramTestMessage(node, callBackFunction) {
        ...
        let botToken = UI.projects.superalgos.utilities.nodeConfig.loadPropertyFromNodeConfig(node.payload, 'botToken')
        let chatId = UI.projects.superalgos.utilities.nodeConfig.loadPropertyFromNodeConfig(node.payload, 'chatId')
    ...
    function sendDiscordTestMessage(node, callBackFunction) {
        ...
        let webhookURL = UI.projects.superalgos.utilities.nodeConfig.loadPropertyFromNodeConfig(node.payload, 'webhookURL')
