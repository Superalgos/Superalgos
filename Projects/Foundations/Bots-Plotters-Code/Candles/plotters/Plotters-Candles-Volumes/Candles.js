function newCandlesPlottersCandlesVolumesCandles() {
    ...
    function onMouseOver(event) {
        let userPosition = UI.projects.foundations.utilities.dateRateTransformations.getDateFromPointAtBrowserCanvas(event, thisObject.container, coordinateSystem)
    ...
    function recalculateUsingDailyFiles() {
        ...
        try {
            ...
            let leftDate = UI.projects.foundations.utilities.dateRateTransformations.getDateFromPointAtBrowserCanvas(UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft, thisObject.container, coordinateSystem);
            let rightDate = UI.projects.foundations.utilities.dateRateTransformations.getDateFromPointAtBrowserCanvas(UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topRight, thisObject.container, coordinateSystem);
    ...
    function plotChart() {
        ...
        try {
            ...
            if (UI.projects.foundations.spaces.chartingSpace.viewport.zoomTargetLevel < UI.projects.foundations.globals.zoom.ZOOM_OUT_THRESHOLD_FOR_PLOTTING_IN_LOW_RESOLUTION) {
            ...
            if (candles.length > 0) {
                ...
                for (let i = 0; i < candles.length; i++) {
                    ...
                    candle.candlePoint1 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(candle.candlePoint1, thisObject.container);
                    candle.candlePoint2 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(candle.candlePoint2, thisObject.container);
                    candle.candlePoint3 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(candle.candlePoint3, thisObject.container);
                    candle.candlePoint4 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(candle.candlePoint4, thisObject.container);

                    /* Skip the first candle with zero at open */
                    if (candle.open === 0) { continue }

                    if (candle.candlePoint2.x < UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomLeft.x || candle.candlePoint1.x > UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomRight.x) {
                        continue
                    }
                    ...
                    candle.stickPoint1 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(candle.stickPoint1, thisObject.container);
                    candle.stickPoint2 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(candle.stickPoint2, thisObject.container);
                    candle.stickPoint3 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(candle.stickPoint3, thisObject.container);
                    candle.stickPoint4 = UI.projects.foundations.utilities.coordinateTransformations.transformThisPoint(candle.stickPoint4, thisObject.container);

                    if (UI.projects.foundations.spaces.chartingSpace.viewport.zoomTargetLevel < UI.projects.foundations.globals.zoom.ZOOM_OUT_THRESHOLD_FOR_PACKING_OBJECTS_AT_THE_BOTTOM_OR_TOP_OF_VIEWPORT) {
                        let diffA = candle.stickPoint3.y - UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.bottomLeft.y
                        if (diffA > 0) {
                        ...
                        let diffB = candle.stickPoint1.y - UI.projects.foundations.spaces.chartingSpace.viewport.visibleArea.topLeft.y
                        if (diffB < 0) {
                    ...
                    candle.candlePoint1 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(candle.candlePoint1);
                    candle.candlePoint2 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(candle.candlePoint2);
                    candle.candlePoint3 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(candle.candlePoint3);
                    candle.candlePoint4 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(candle.candlePoint4);
                    ...
                    candle.stickPoint1 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(candle.stickPoint1);
                    candle.stickPoint2 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(candle.stickPoint2);
                    candle.stickPoint3 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(candle.stickPoint3);
                    candle.stickPoint4 = UI.projects.foundations.spaces.chartingSpace.viewport.fitIntoVisibleArea(candle.stickPoint4);
