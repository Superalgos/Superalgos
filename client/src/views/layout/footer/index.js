          ...
          >
            <Grid item xs={12} sm={4} md={4}>
              ...
              <Grid
                ...
                direction='column'
              >
                <Typography variant='subtitle2' className={classes.textLight}>
                  <strong>Advanced Algos Ltd.</strong>
                </Typography>
                <Typography
                  variant='subtitle1'
                ...
                >
                  ...
                  <br />
                  St. Julians&nbsp;STJ3049, Malta
                </Typography>
                <Typography variant='subtitle1' className={classes.textLight}>
                  <Link
                    to='legal-privacy-statement.shtml'
                  ...
                  |{' '}
                  <a
                    href='legal-terms-of-service.shtml'
                    className={classes.linkLight}
                  >
                    Terms of Service
                  </a>
                ...
                <Typography
                  variant='body2'
                  className={classNames(classes.textLight, classes.copyright)}
                  gutterBottom
                >
                  &copy; Advanced Algos, Ltd. 2018 | All Rights Reserved.
                </Typography>
              </Grid>
            </Grid>
            ...
            <Grid item xs={12} sm={7} md={6}>
              ...
              <Typography
                ...
                style={{ textAlign: width === 'xs' ? 'center' : '' }}
              >
              ...
              >
                <Link
                  to='https://t.me/advancedalgoscommunity'
                ...
                <Link
                  to='https://twitter.com/advancedalgos'
                ...
                <Link
                  to='https://www.facebook.com/Advanced-Algos-173249670001615/'
