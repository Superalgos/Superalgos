        ...
        */
        ...
        function distributeProgram(programNode) {
            ...
            */
            ...
            distributeProgramPower(programNode, programNode, programPower)
            ...
            function distributeProgramPower(
                ...
                */
                if (
                    ...
                    distributeProgramPower(currentProgramNode, node.payload.referenceParent, programPower / 10)
                    return
                }
                /*
                    ...
                    for (let i = 0; i < schemaDocument.childrenNodesProperties.length; i++) {
                        ...
                        switch (property.type) {
                            case 'node': {
                                ...
                                distributeProgramPower(currentProgramNode, childNode, programPower * percentage / 100, percentage)
                            }
                                break
                            case 'array': {
                                let propertyArray = node[property.name]
