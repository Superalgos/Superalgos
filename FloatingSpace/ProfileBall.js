...
function newProfileBall() {
    ...
    function drawBackground(pFloatingObject) {
        ...
        if (pFloatingObject.currentRadius > 1) {
            ...
            browserCanvasContext.lineTo(pFloatingObject.input.position.x, pFloatingObject.input.position.y);
        ...
        if (pFloatingObject.currentRadius > 0.5) {
            ...
            browserCanvasContext.beginPath();
            browserCanvasContext.arc(pFloatingObject.input.position.x, pFloatingObject.input.position.y, radius, 0, Math.PI * 2, true);
    ...
    function drawForeground(pFloatingObject) {
        ...
        if (pFloatingObject.input.imageId !== undefined) {

            let image = document.getElementById(pFloatingObject.input.imageId);
        ...
        if (pFloatingObject.currentRadius > 6) {
            ...
            label = pFloatingObject.input.upLabel;
            ...
            label = pFloatingObject.input.downLabel;
