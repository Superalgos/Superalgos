...
Download the software package from the [latest software release](https://github.com/Superalgos/DesktopApp/releases/tag/v.0.0.1-alpha) (```Superalgos-Desktop-App.zip```) and extract in an accessible route (you will launch the app from these folders).

Download historic market data from the [latest data release](https://github.com/Superalgos/DesktopApp/releases/tag/data.poloniex.btc.usdt.2019.08.27) (```Poloniex.BTC.USDT.Historic.Data.zip```) and extract inside the ```Superalgos DEsktop App``` folder generated by the software package ZIP.
...
How you extract/unpack the files depends on the software you use to handle ZIP files. Double clicking the ZIP file should wrk in most scenarios. You may also right-click the file and check the options available on the menu.
...
The ZIP file includes highly-compressed complete historic BTC/USDT market data at Poloniex. Expect decompression to take from 1 to 2 hours, depending on your system. Once you have the historic data, the app will make sure the data stays up to date.
