exports.newTradingSignalsModulesIncomingCandleSignals = function () {
    ...
    async function signalReceived(signalMessage, rankingStats) {
        ...
        */
       TS.projects.foundations.functionLibraries.taskFunctions.taskHearBeat("Candle Signal received, delayed " + rankingStats.accumulatedDelay / 1000 + " secsonds. Position in Queue: " + rankingStats.positionInQueue + " / " + rankingStats.queueSize)
        /*
