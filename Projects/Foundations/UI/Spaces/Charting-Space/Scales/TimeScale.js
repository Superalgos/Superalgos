function newTimeScale() {
    ...
    function positioningPhysics() {
        ...
        let mouseDate = UI.projects.foundations.utilities.dateRateTransformations.getDateFromPointAtBrowserCanvas(timePoint, limitingContainer, coordinateSystem)
    ...
    function drawScale() {
        ...
        const NUMBER_OF_LABELS = Math.trunc(UI.projects.foundations.spaces.chartingSpace.viewport.width / SEPARATION)
        const FONT_SIZE = 15
        ...
        for (let i = 0; i <= NUMBER_OF_LABELS; i++) {
            ...
            let time = UI.projects.foundations.utilities.dateRateTransformations.getDateFromPointAtBrowserCanvas(timePoint, limitingContainer, coordinateSystem)
