...
{
    public class AlgoMinerMigrateMinerCommand : EthInvokeTransactionalFunctionCommand
    {
        public string NewMinerAddress { get; set; }
        ...
        protected override async Task<TransactionReceipt> ExecuteAsync(RuntimeContext context, string contractAddress, Web3 web3)
        {
            ...
            return await algoMiner.MigrateMinerAsync(context.ResolveContractReference(NewMinerAddress));
        }
    }
}
