    ...
    function drawTitleBackground() {
        if (thisObject.editMode !== true) {
            let params = {
                ...
                borderColor: UI.projects.foundations.spaces.floatingSpace.style.backgroundColor,
                backgroundColor: UI.projects.foundations.spaces.floatingSpace.style.backgroundColor,
                castShadow: false,
                opacity: 0.25
            }
        ...
        if (thisObject.editMode !== true) {
            ...
            if (radius > 6 && (thisObject.isOnFocus === true || thisObject.allwaysVisible === true || thisObject.isDefault === false)) {
                ...
                if (label !== undefined) {
                    ...
                    if (UI.projects.foundations.spaces.floatingSpace.inMapMode === true) {
                        labelPoint = UI.projects.foundations.spaces.floatingSpace.transformPointToMap(labelPoint)
